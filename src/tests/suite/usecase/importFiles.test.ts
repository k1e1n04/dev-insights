...
suite("importFiles Tests", () => {
  ...
  test("should import files from selected folder", async () => {
    ...
    readFileStub
      .withArgs("/path/to/folder/file1.md", "utf-8")
      .resolves("File 1 content");
    readFileStub
      .withArgs("/path/to/folder/file2.md", "utf-8")
      .resolves("File 2 content");
    ...
    sinon.assert.callCount(
      chromaDBClientStub.importFiles as sinon.SinonStub,
      2,
    );
    sinon.assert.calledWith(
      chromaDBClientStub.importFiles as sinon.SinonStub,
      "/path/to/folder/file1.md",
    );
    sinon.assert.calledWith(
      chromaDBClientStub.importFiles as sinon.SinonStub,
      "/path/to/folder/file2.md",
    );

    sinon.assert.calledWith(
      streamStub.markdown as sinon.SinonStub,
